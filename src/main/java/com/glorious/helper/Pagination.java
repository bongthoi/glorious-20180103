...
public class Pagination {
	...
	private int s_recore=0;
	private int t_recore=0;
	
	
	
	public int getS_recore() {
		return s_recore;
	}
	public void setS_recore(int s_recore) {
		this.s_recore = s_recore;
	}
	public int getT_recore() {
		return t_recore;
	}
	public void setT_recore(int t_recore) {
		this.t_recore = t_recore;
	}
	public int getNextp() {
		return nextp;
	}
	...
	public Pagination(int curent_page,int total_record){
		...
		this.total_record=total_record;
		 if (this.limit < 0){
		  ...
		  this.nextp =	this.current_page+1;
		  this.previousp=this.current_page-1;
		  if(this.current_page==1){
			  this.previousp=this.current_page;
		  }
		  this.s_recore=  this.start+1;
		  this.t_recore=  this.start+ this.limit;
		  if( this.t_recore>this.total_record){
			  this.t_recore=this.total_record;
		  }
	}
