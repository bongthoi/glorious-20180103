 $(function () {
	    ...
	    $(".btn-catgory-edit").click(function(){
	    	var Catgory=$(this).data('catgory');
			 ...
			 $('.box-title').html('<i class="fa fa-tag"></i> Category Update');
	 ...
	 //Enable iCheck plugin for checkboxes
	   ...
	   $("#do_delete_newscatgory1,#do_delete_newscatgory2").click(function(){
		     ...
		     if(ids.length>0){
		    	 ...
		    	 $.post("admin/ajax/news/catgory/delete",pdata,function(data){
	  ...
	  function do_insert_catgory(pdata){
		   $.post("admin/ajax/news/catgory/insert",pdata,function(data){
		 		 if(parseInt(data) == 1){
	  ...
	  function do_update_catgory(pdata){
		   $.post("admin/ajax/news/catgory/update",pdata,function(data){
		 		 //alert(data);
		 		 if(parseInt(data) == 1){
