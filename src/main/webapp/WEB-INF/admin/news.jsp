    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
		         <a href="admin/news/post-new" class="btn btn-success">Add new post</a>
		   <div class="box-tools pull-right">
                <div class="has-feedback">
                  <select class="form-control input-sm" id="sle_news-catgory" data-option="${_selected}" >
        ...
        <div class="box-body table-responsive no-padding tb-post">
		      <div class="mailbox-controls">
                ...
                ${pag.s_recore}-${pag.t_recore}/${pag.total_record}
                  <div class="btn-group">
                 	 <a href="admin/news?${paramcatgory}p=${pag.previousp}" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                    <a href="admin/news?${paramcatgory}p=${pag.nextp}" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>
                  </div>
                  <!-- /.btn-group -->
                </div>
                <!-- /.pull-right -->
              ...
              <c:forEach var="new_o" items="${news}" varStatus="loopCounter">
                   <tr>
		                ...
		                <td><a  href="admin/news/post-edit/${new_o.id}"><i class="fa fa-pencil"></i></a></td>
		                  <td>${new_o.feature_image}</td>
		                  <td><span class="text-primary">${new_o.title}</span></td>
		                  <td>${new_o.creator}</td>
		              		<td><span class="text-primary">${new_o.catgory_name}</span></td>
