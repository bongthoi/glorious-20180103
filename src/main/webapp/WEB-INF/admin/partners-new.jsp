    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="admin/Partners">partners</a></li>
          <li><a href="admin/Partners/new">New</a></li>
      </ol>
    </section>
		    	...
		    	<form method="post" id="frm-partners">
		    		<div class="col-md-9">
					        ...
					        <div class="box-body">
					    			...
					    			<div class="form-group">
					    				...
					    				<textarea class="form-control" rows="10" cols="10" name="description"></textarea>
					    			</div>
					        </div>
					         <div class="box-footer no-padding">
					              <div class="mailbox-controls">
					                <!-- Check all button -->
					               <a class="btn btn-app btn-primary" id="btnnewpartners">
		    		...
		    		<div class="col-md-3">
	    				...
	    				<div class="box box-primary">
	    					...
	    					<div class="box-body">
	    							 <img alt="" src="upload/no_image.jpg" class="img img-responsive" style="margin:0 auto;" id="img-feature_image_partners">
	    							 <input type="hidden" name="logo" value="no_image.jpg">
	    					</div>
