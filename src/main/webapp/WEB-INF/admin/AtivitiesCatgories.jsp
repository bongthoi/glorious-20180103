...
<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
      <h1>
       Activities Categories <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="admin/"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="admin/activities/category">Activities Category</a></li>
      </ol>
    </section>
	...
	<div class="row">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
		    <h3 class="box-title"><i class="fa fa-tag"></i> Add News Activities Category</h3>
  ...
  <script src="js/activities/category.js"></script>